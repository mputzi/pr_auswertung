...
class PR_Exercises(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.exercise_title = tk.Label(
            self, text="Aufgabenerfassung", font=myfont)
        ...
        self.l_exercise_number = tk.Label(
            self.f_exercise_number, text="Aufgabenanzahl:")
        self.l_exercise_number.grid(row=0, column=0)
        self.sb_exercise_number = tk.Spinbox(
            self.f_exercise_number, from_=1, to=20, width=4, justify=tk.CENTER)
        self.sb_exercise_number.grid(row=0, column=1)
        self.b_exercise_number = tk.Button(
            self.f_exercise_number, text="setze")
        self.b_exercise_number.grid(row=0, column=2)

        # LabelFrame: Eingabe
        self.lf_exercise_details = tk.LabelFrame(
            self, text="Aufgabendetails", cursor="trek")
        self.lf_exercise_details.grid(row=2, column=0, sticky="nwe")

        self.lf_exercise_details.columnconfigure(
            1, weight=1)  # Spalte der Canvas
        ...
        # Aufgabeneingabe
        # Zeilenbschriftungen
        self.l_exercises = tk.Label(
            self.f_exercise_details_labels, text="Aufgabenbezeichnung")
        self.l_exercises.configure(pady=3)
        self.l_exercises.grid(row=0, column=0, sticky="nw")
        self.l_exercises_points = tk.Label(
            self.f_exercise_details_labels, text="Errechbare BE")
        ...
        self.f_exercises_forCanvas = tk.Frame(
            self.lf_exercise_details, bg="white")
        ...
        self.c_exercises = tk.Canvas(
            self.f_exercises_forCanvas, relief=tk.SUNKEN, bd=2, highlightcolor="blue", bg="bisque")
        ...
        # Frame: Eingabe
        self.f_exercise_details_entries = tk.Frame(
            self.c_exercises, relief=tk.FLAT, bd=1, highlightcolor="blue", bg="bisque")
        ...
        self.w_entries = canvas.create_window(
            (0, 0), window=entries_f, anchor="nw", height=50)

        # Zwei Eingabefelder
        # Aufgabeneingabe
        ex1 = tk.StringVar()
        nameEntry = tk.Entry(entries_f, textvariable=ex1, width=3,
                             bg="yellow", relief=tk.FLAT, bd=2, highlightcolor="blue")
        ...
        # Punkteeingabe
        ex1_p = tk.DoubleVar()
        pointsEntry = tk.Entry(entries_f, textvariable=ex1_p, width=3, bg="white",
                               justify=tk.RIGHT, relief=tk.FLAT, bd=2, highlightcolor="blue")
        ...
        self.scrbar_exercises = tk.Scrollbar(
            self.f_exercises_cBottomFrame, orient=tk.HORIZONTAL, command=canvas.xview)
        self.scrbar_exercises.grid(row=0, column=0, sticky="ew")

        canvas.configure(scrollregion=canvas.bbox(tk.ALL),
                         xscrollcommand=self.scrbar_exercises.set)
        ...
        self.l_all_points = tk.Label(
            self.f_all_points, text="Gesamtpunktzahl:")
        self.l_all_points.grid(row=0, column=0)
        self.max_points = tk.StringVar()
        self.e_all_points = tk.Entry(
            self.f_all_points, textvariable=self.max_points, width=4, justify=tk.CENTER, relief=tk.FLAT)
        self.e_all_points.configure(
            state=tk.DISABLED, takefocus="NO", disabledforeground="black", disabledbackground="yellow")
    ...
    def change_entry_widgets(self, number):
        ...
        if n < number:
            ...
            for i in range(d):
                ex = tk.StringVar()
                nameEntry = tk.Entry(entries_f, textvariable=ex, width=3,
                                     bg="yellow", relief=tk.FLAT, bd=2, highlightcolor="blue")
                ...
                ex_p = tk.DoubleVar()
                pointsEntry = tk.Entry(entries_f, textvariable=ex_p, width=3, bg="white",
                                       justify=tk.RIGHT, relief=tk.FLAT, bd=2, highlightcolor="blue")
